	...
	<div class="col-md-8 col-sm-8 col-xs-12">
		...
		<div class="table" style="margin-top:20px;display:none" id="manual_entry">
			<div class="table-row">
				...
				<div class="table-cell" style="padding-left:20px;vertical-align:top">
					<select id="recipients" style="display:inline-block;width:400px" class="form-control" multiple="multiple"></select>
				</div>
			</div>
		</div>
		<div class="table" style="margin-top:20px;display:none" id="upload_entry">
			...
			<form id="recipients-form" action="/?a=upload_demandgen_list" target="recipients-frame" method="post" enctype="multipart/form-data" style="margin:0px">
				<div class="table-row">
					<div class="table-cell" style="width:230px">
						<label for="recipients">Please upload a list or recipients in a csv spreadsheet. There should be one column with the email addresses of the recipients. You can send an email to up to 200 contacts.</label>
					</div>
					<div class="table-cell" style="padding-left:20px;vertical-align:top">
		...
		<div class="form-group">
			...
			<input type="subject" class="form-control" id="subject" style="display:inline-block;width:450px;margin-left:20px;color:#000" value="' . Core::safe_echo($data['email_template']['subject']) . '">
