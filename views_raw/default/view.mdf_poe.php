...
$data['mdf']['poe_form'] = Core::r('mdf')->get_form([
            'mdf_form_id' => 2
        ]);
...
<div class="row">
	...
	<div class="col-md-9 col-sm-9 col-xs-12 content2">
		...
		<div>
			<div class="module-title" style="display:inline-block">MDF Proof of Execution</div>
			<div style="display:inline-block" class="pull-right">
				<a href="/?p=mdf_activities" class="btn btn-primary">Return to Activities</a>
			</div>
		</div>
		<div id="mdf_order_result_h" style="margin:20px 0px"></div>
/end_view
		<? foreach($data['mdf']['poe_form']['form'] as $k => $section) {
