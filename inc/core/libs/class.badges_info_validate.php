...
*/
class Core_Badges_Info_Validate {
	...
	*/
	function run($options = array()) {
		...
		*/
		...
		/*
		We need to check if this is a badge requirement. If it is, then it needs to be registered in Core_Badge_Reqs.
		If this info_type is registered in Core_Badge_Reqs but it is not a badge requirement, that is also an error.
		Test for those conditions
		*/

		// Determine if this info_type is registered in Core_Badge_Reqs.
		global $gamo;
