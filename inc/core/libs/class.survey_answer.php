    ...
    */
    function get_answers($options = array()){
        ...
        */
        ...
        $sql = "SELECT survey_answers_id as id, answer as text FROM " . CORE_DB . ".`survey_answers` WHERE survey_questions_id = :questionid and active = 1";
