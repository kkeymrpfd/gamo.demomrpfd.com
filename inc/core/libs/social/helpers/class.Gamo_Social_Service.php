<?php
class Core_Social_Service implements Core_IAccount_Updatable, Core_IHttp_Fetchable, Core_IScrapable{
	...
	public function add_account_handler(Core_IAccount_Handler $ah){
	
		$this->account_handler = $ah;
	
	}
	
	public function add_http_handler(Core_IHttp_Handler $hh){
	
		$this->http_handler = $hh;
	
	}
	
	public function add_scraper(Core_IScraper $sc){
