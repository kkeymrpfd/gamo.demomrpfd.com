...
class Core_Social_Account{
	...
	public function delete_account($options=array()){
		...
		$sql = "DELETE FROM " . CORE_DB . '.users_info WHERE user_id = :user_id and info_type = :account_type';
	...
	public function find_accounts($options=array()){
		...
		$sql = 'SELECT user_id, int_info as s_user_id, info as username, info_b as access_token FROM ' . CORE_DB .
