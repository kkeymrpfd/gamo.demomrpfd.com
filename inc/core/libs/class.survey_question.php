...
class Core_Survey_Question {
    ...
    function get_question_type($question_id){
        ...
        $sql = "SELECT question_type FROM " . CORE_DB . ".`survey_questions` WHERE survey_questions_id = :surveyquestionid and active = 1";
    ...
    */
    function get_questions($options = array()){
        ...
        */
        ...
        $sql = "SELECT survey_questions_id as question_id, question_order as question_label, question as text, question_type as answer_type FROM " . CORE_DB . ".`survey_questions` WHERE survey_id = :surveyid and active = 1";
    ...
    function create_survey_question($options = array()){
        ...
        */
        ...
        $question_id = Core::db_insert(array(
                'table' => '' . CORE_DB . '.survey_questions',
                'values' => array(
