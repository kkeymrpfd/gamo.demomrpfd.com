...
$slug_names_like_post_comment = array(
		'facebookLikePostVmware', 'facebookLikePostHp', 'facebookLikePostMcpc',
		'facebookPostWallVmware', 'facebookPostWallHp', 'facebookPostWallMcpc',
		'facebookCommentPostVmware', 'facebookCommentPostHp', 'facebookCommentPostMcpc' );
...
if(!empty($action_types)){
	...
	//$options_obj->unlock_scraper(array('scraper_slug' => 'facebookShare'));
	
	$fb->get_likes_comments_wposts($options);
