...
*/
class Gamo_Survey_Answer_Choice {
    ...
    */
    function get_answer_choices($options = array()){
        ...
        */
        ...
        $sql = "SELECT survey_answers_choices_id as id, answer as text FROM " . GAMO_DB . ".`survey_answer_choices` WHERE survey_questions_id = :questionid and active = 1";
    ...
    function create_survey_answer_choice($options = array()){
        ...
        */
        ...
        $answer_choice_id = Core::db_insert(array(
                'table' => '' . GAMO_DB . '.survey_answer_choices',
                'values' => array(
