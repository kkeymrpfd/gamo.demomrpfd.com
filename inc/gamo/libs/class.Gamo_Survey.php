    ...
    */
    function get_surveys($options = array()){
        ...
        */
        ...
        $sql = "SELECT survey_id, title as survey_title, descrip as survey_description FROM " . GAMO_DB . ".`surveys` WHERE user_id = :userid and active = 1 ORDER BY created_time DESC LIMIT " .$options['start'] . "," . $options['num'];
