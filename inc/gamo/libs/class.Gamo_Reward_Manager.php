	...
	*/
	function get_badges($options = array()) {
		...
		*/
		...
		FROM
		" . GAMO_DB . ".badges AS badges ORDER BY ordered ASC, badge_name ASC
		";
	...
	function get_badge($options = array()) {
		...
		$sql = 'SELECT badge_id, badge_name, rank FROM ' . GAMO_DB . '.badges WHERE badge_id = :badge_id';
