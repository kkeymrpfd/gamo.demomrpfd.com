...
class Campaign {
        ...
        public $__campaignID                   =               42;                                                     # Campaign ID (@var int)
        ...
        private function __campaignRequest($command, $pin = null, $data = null, $status = null) {
                ...
                if(!isset($_SERVER["SERVER_NAME"])) {
                       ...
                       $_SERVER["SERVER_NAME"] = 'from_cli_environment';
        ...
        public function getPinByEmail($email){
                $pin = $this->__campaignRequest("getpinbyemail", $email);
        ...
        public function addNewUser($pin, $info, $status = 2){
                $data = array();
                ...
                $data = serialize($data);
                $request = $this->__campaignRequest("addnew", $pin, $data, $status);
